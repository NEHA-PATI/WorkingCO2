...
// AssetCard styles are in global.css (imported in OrgDashboard)
  ...
  return (
    ...
    >
      ...
      <div className="mb-1">
        ...
        <span className="badge bg-blue-light text-blue text-xs font-medium mt-1">
          {asset.type}
        </span>
      </div>
      ...
      <div className="flex items-center justify-between mt-2">
        <div className="flex items-center space-x-1">
          <TrendingUpIcon
            style={{ color: "#10b981", width: 12, height: 12 }}
          />
      ...
      <div className="flex items-center justify-between mt-2">
        ...
        <span
          className={`badge ${
            asset.verified ? "bg-green-light" : "bg-gray-light"
          }`}
          style={{
