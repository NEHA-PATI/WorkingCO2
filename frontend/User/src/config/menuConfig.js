...
export const USER_ORG_MENU = {
  ...
  user: [
    { label: "Dashboard", path: "/user/dashboard", icon: MdDashboard, color: "#2e7d32" },
  ...
  organization: [
    { label: "Dashboard", path: "/org/dashboard", icon: MdDashboard, color: "#2e7d32" },
    { label: "Add Asset", path: "/add-asset", icon: MdUpload, color: "#8e24aa" },
    { label: "Wallet", action: "/wallet", icon: GiWallet, color: "#f59e0b" },
    { label: "Community", path: "/community", icon: FaUsers, color: "#28a745" },
    { label: "Blog", path: "/blog", icon: FaBlog, color: "#ff5722" },
    { label: "Case Studies", path: "/case-studies", icon: FaBookOpen, color: "#17a2b8" },
...
export const ADMIN_MENU = [
  ...
  { label: "Case Study Management", path: "/case-study-management", icon: FaBookOpen },
  ...
  { label: "Community Management", path: "/community-management", icon: FaUsers },
